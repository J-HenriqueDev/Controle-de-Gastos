                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" class="form-control" name="valor_da_entrada" id="valor_da_entrada" value="{{$entrada->valor_da_entrada}}" placeholder="1,800" required>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="date" class="form-control" name="data_da_entrada" id="data_da_entrada" value="{{$entrada->data_da_entrada}}" required>
