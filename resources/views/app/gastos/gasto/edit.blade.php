                    ...
                    <div class="row mb-3">
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input type="number" class="form-control" name="valor_do_gasto" id="valor" value={{$gasto->valor_do_gasto}}
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group input-group-merge">
                                <input type="date" class="form-control" name="data_do_gasto" id="data" value={{$gasto->data_do_gasto}} required>
